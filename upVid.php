...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                <form method="POST" action="upVid_proses.php"  enctype="multipart/form-data" class="user">
    ...
    <input type="file" accept="video/mp4 , video/3gp , video/webm" name="vid" id="userImage" required="" />
    </p>
                                </div>
