...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                <form method="POST" action="editNote_proses.php"  enctype="multipart/form-data" class="user">
                                <?php
                                    $id = $_GET['id'];
                                ...
                                <div class="form-group">
                                    <span> Judul : </span><br>
                                        <input type="text" class="form-control form-control-user"
                                            id="exampleInpputName" name="nama" disabled placeholder="Nama"value="<?php echo $row['nama_note'];?>">
                                </div>
                                <div class="form-group">
                                    <span> Deskripsi : </span><br>
                                        <textarea name="des"  class="form-control form-control-user" disabled ><?php echo $row['des_note'];}?></textarea>
                                       
                                    </div>
                                <a href="note.php"><input type="button" value="Back" class="btn btn-primary btn-user btn-block"/></a>
                                <hr>
                            </form>    
