...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                <form method="POST" action="addNote_proses.php"  enctype="multipart/form-data" class="user">
                                ...
                                <div class="form-group">
                                    <span> Deskripsi : </span><br>
                                        <textarea name="des"  class="form-control form-control-user">Enter text here...</textarea>
                                </div>
