                                ...
                                <div class="form-group">
                                    <span> Judul : </span><br>
                                        <input type="text" class="form-control form-control-user"
                                            id="exampleInpputName" name="nama" placeholder="Nama"value="<?php echo $row['nama_note'];?>">
                                </div>
                                <div class="form-group">
                                    <span> Deskripsi : </span><br>
                                        <textarea name="des"  class="form-control form-control-user"><?php echo $row['des_note'];?></textarea>
                                        <input type="hidden" name="id_note" autofocus="" required="" value="<?php echo $row['id_note'];}?>"/>
                                    </div>
