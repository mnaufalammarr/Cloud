...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Upload Picture</h6>
                                </div>
                                <div class="card-body">
                               
                                <form method="POST" action="editPic_proses.php"  enctype="multipart/form-data" class="user">
                                <?php
                                    $id = $_GET['id'];
                                    $query = "SELECT * FROM tb_pic WHERE id_pic ='$id' ";
                                ...
                                <div class="form-group">
                                    <span> Nama : </span><br>
                                        ...
                                        <input type="text" class="form-control form-control-user"
                                            id="exampleInpputName" name="nama" placeholder="Nama" value="<?php echo $row['nama_pic'];?>">
                                </div>
                                <div class="form-group">
                                <p>
    ...
    <label for="userImage">
    <a class="btn btn-info btn-sm" rel="nofollow"><span class='glyphicon glyphicon-paperclip'></span> Sisipkan Gambar</a>
    </label>
    <input type="file" accept="image/png, image/jpeg, image/jpg" name="userImage" id="userImage" required="" /><?php echo $row['url_pic'];?>
    <input type="hidden" name="id_pic" autofocus="" required="" value="<?php echo $row['id_pic'];}?>"/>
</p>
                                </div>
