                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            ...
                            $queryPic = "SELECT count(*) AS total FROM tb_pic ";
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Video</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php
                            $queryPic = "SELECT count(*) AS total FROM tb_vid ";
                            $resultPic = mysqli_query($conn, $queryPic);
                            while($row = mysqli_fetch_assoc($resultPic))
                            { echo $row['total'];}?></div>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                File</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php
                            $queryPic = "SELECT count(*) AS total FROM tb_file ";
                            $resultPic = mysqli_query($conn, $queryPic);
                            while($row = mysqli_fetch_assoc($resultPic))
                            { echo $row['total'];}?></div>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Note</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php
                            $queryPic = "SELECT count(*) AS total FROM tb_note ";
                            $resultPic = mysqli_query($conn, $queryPic);
                            while($row = mysqli_fetch_assoc($resultPic))
                            { echo $row['total'];}?></div>
                                        </div>
