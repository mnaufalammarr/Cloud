...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="card shadow mb-4">
                                ...
                                <form method="POST" action="editVid_proses.php"  enctype="multipart/form-data" class="user">
                                <?php
                                    $id = $_GET['id'];
                                    $query = "SELECT * FROM tb_vid WHERE id_vid ='$id' ";
                                ...
                                <div class="form-group">
                                    <span> Nama : </span><br>
                                        ...
                                        <input type="text" class="form-control form-control-user"
                                            id="exampleInpputName" name="nama" placeholder="Nama" value="<?php echo $row['nama_vid'];?>">
                                </div>
                                <div class="form-group">
                                <p>
    Sisipkan File / Video ( Max 10Mb ):
    </p>
    <p class="image_upload">
    <label for="userImage">
    <a class="btn btn-info btn-sm" rel="nofollow"><span class='glyphicon glyphicon-paperclip'></span> Sisipkan Video</a>
    </label>
    <input type="file" accept="video/mp4 , video/3gp , video/webm" name="vid" id="userImage" required="" /><?php echo $row['url_vid'];?>
    <input type="hidden" name="id_vid" autofocus="" required="" value="<?php echo $row['id_vid'];}?>"/>
</p>
                                </div>
