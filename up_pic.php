...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                <form method="POST" action="upPic_proses.php"  enctype="multipart/form-data" class="user">
                                
                                <div class="form-group">
                                    <span> Nama : </span><br>
                                        <input type="text" class="form-control form-control-user"
                                            id="exampleInpputName" name="nama" placeholder="Nama">
                                </div>
                                <div class="form-group">
                                <p>
    ...
    <input type="file" accept="image/png, image/jpeg, image/jpg" name="userImage" id="userImage" required="" />
    </p>
                                </div>
